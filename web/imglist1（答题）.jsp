...
<body>
    ...
    <c:forEach items="${requestScope.questions}" var="question" varStatus="st">
        ...
        <input type="radio" class="optionsRadios1 ch" value="A" name="optionsRadios+'<c:out value='${st.index+1}'/>'"  />
        <label>A．<c:out value="${question.optionOne}"/></label>
        <br />
        <input type="radio" class="optionsRadios2 ch" value="B" name="optionsRadios+'<c:out value='${st.index+1}'/>'" />
        <label>B．<c:out value="${question.optionTwo}"/></label>
        <br />
        <input type="radio" class="optionsRadios3 ch" value="C" name="optionsRadios+'<c:out value='${st.index+1}'/>'"  />
        <label>C．<c:out value="${question.optionThree}"/></label>
        <br />
        <input type="radio" class="optionsRadios4 ch" value="D" name="optionsRadios+'<c:out value='${st.index+1}'/>'"  />
